                    ...
                    <tbody>
                        <tr class="w-full hover:bg-gray-100 border-gray-200 border-b">
                            <td class="flex items-center gap-2">
                                ...
                                <p class="capitalize">auto renew</p>
                            </td>
                            <td class="overflow-hidden">
                                <p class="capitalize text-wrap text-balance line-clamp-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. </p>
                            </td>
        ...
        <div class="col-span-3 w-full pr-5">
             <form action="" method="POST" class="w-full bg-white rounded-lg p-5">
                ...
                <div x-data="{  
                    ...
                    link: '',
                    isFormValid() {
                        return this.name.trim() !== '' && this.description.trim() !== '' && this.link.trim() !== '';
                    }
                }" 
                class="space-y-4">
                    <!-- Daily Clean Input -->
