...
@section('content')
            ...
            <div class="grid grid-cols-12">
                <div class="breadcrumbs text-sm col-span-4">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('products.index', $product) }}">Products</a>
                        </li>
                        <li>Add Models</li>
                    </ul>
                </div>
    ...
    <div class="grid grid-cols-12 space-x-5 mt-5">
                            ...
                            <td class="inline-flex items-center gap-2 float-end">
                                <div class="dropdown dropdown-hover dropdown-end">
                                    ...
                                    <ul tabindex="0"
                                        ...
                                        <li>
                                            <a href="{{ route('details.index', [$brand, $product, $item->id]) }}"
                                                ...
                                                <p>Describe Concepts Lists</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('functions.index', [$brand->name, $product->name, $item->name]) }}"
                                                class="join-item px-4 py-2 inline-flex items-center gap-2 rounded-sm  border-s-[3px] border-blue-500 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white transition-all duration-300">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" width="24" height="24"
                                        ...
                                        <li>
                                            <a href="{{ route('daily-cleans.index', [$brand, $product, $model]) }}"
                                                class="join-item px-4 py-2 inline-flex items-center gap-2 rounded-sm  border-s-[3px] border-blue-500 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white transition-all duration-300">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <li>
                                            <a href="{{ route('deep-cleans.index', [$brand, $product, $model]) }}"
                                                class="join-item px-4 py-2 inline-flex items-center gap-2 rounded-sm  border-s-[3px] border-blue-500 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white transition-all duration-300">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        ...
                                        <li>
                                            <a href="{{ route('show-rooms.index', [$brand, $product, $model]) }}"
                                                class="join-item px-4 py-2 inline-flex items-center  gap-2 rounded-sm  border-s-[3px] border-blue-500 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white transition-all duration-300">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        fill="none" stroke="currentColor" stroke-linecap="round"
        ...
        <form action="{{ route('models.store', [$brand ?? null, $product ?? null]) }}" method="POST" class="w-full bg-white rounded-lg p-5">
            @csrf
            @method('POST')
            <div x-data="{
                name: '',
