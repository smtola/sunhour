<div class="w-full border-b-2 border-white pt-[.5em]">
    <ul class="flex flex-col justify-center items-start gap-2 py-1">
        <li class="flex items-center space-x-3">
            <div class="flex items-start space-x-2">
                <span class="bg-white p-[3px] md:p-1 rounded-full">
                    <svg class="w-[12px] md:w-[14px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                <p class="text-white text-[12px] md:text-[14px]">012 591 200</p>
            </div>
            <div class="flex items-start space-x-2">
                <span class="bg-white p-[3px] md:p-1 rounded-full">
                    <svg class="w-[12px] md:w-[14px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                <p class="text-white text-[12px] md:text-[14px]">admin@sunhour.com</p>
            </div>
        </li>
